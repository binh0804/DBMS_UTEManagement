...
namespace DBMS_UTEManagement
{
    public partial class KhoaHocForm : Form
    {
        ...
        public KhoaHocForm()
        {
            InitializeComponent();
            SetUpNormalState();
            this.dgvKhoaHoc.DefaultCellStyle.Font = new Font("Cambria", 12);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (Them)
            {
                try
                {
                    ...
                    // Thực hiện lệnh 
                    BSNH.AddKhoaHoc(txt_MaKhoaHoc.Text.Trim(),
                                    txt_TenKhoaHoc.Text.Trim());
            ...
            else if(Sua)
            {
                try
                {
                    // Thực hiện lệnh 
                    BSKhoaHoc BSNH = new BSKhoaHoc();
                    BSNH.UpdateKhoaHoc(txt_MaKhoaHoc.Text.Trim(),
                                        txt_TenKhoaHoc.Text.Trim());
        ...
        private void dgvKhoaHoc_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_MaKhoaHoc.Text = dgvKhoaHoc.Rows[r].Cells[0].Value.ToString().Trim();
            txt_TenKhoaHoc.Text = dgvKhoaHoc.Rows[r].Cells[1].Value.ToString().Trim();
        }
