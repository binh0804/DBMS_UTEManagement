...
namespace DBMS_UTEManagement.BSLayer
{
    internal class BSNganhHoc
    {
        ...
        public DataSet AddNganh(string MaNganh, string TenNganh, float MaKhoa)
        {
            SqlParameter p1 = new SqlParameter("@MaNganh", SqlDbType.Char);
            p1.Value = MaNganh;
            SqlParameter p2 = new SqlParameter("@TenNganh", SqlDbType.Char);
            p2.Value = TenNganh;
            SqlParameter p3 = new SqlParameter("@MaKhoa", SqlDbType.Float);
            p3.Value = MaKhoa;
        ...
        public DataSet UpdateNganh(string MaNganh, string TenNganh, float MaKhoa)
        {
            SqlParameter p1 = new SqlParameter("@MaNganh", SqlDbType.Char);
            p1.Value = MaNganh;
            SqlParameter p2 = new SqlParameter("@TenNganh", SqlDbType.Char);
